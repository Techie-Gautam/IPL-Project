...
const PointsTable = () => {
  ...
  return (
    ...
    {loading ? (
      ...
      <div className="p-3 overflow-x-scroll h-fit md:overflow-hidden">
        <table className="w-full table-auto border-separate border-spacing-0 border-gray-300">
          <thead>
            <tr className="text-center text-gray-300">
              ...
              <th className="py-2 px-4">Last 5</th>
            </tr>
          </thead>
            ...
            {tableData.length > 0 &&
              tableData.map(
                (
                  ...
                  <tr className={`text-center ${index % 2 === 0 ? "bg-gray-900" : "bg-gray-700"}`}>
                    <td className="text-left py-3 px-4">
                      <div className="flex items-center gap-5">
                        <span className="font-bold text-gray-400 w-5 text-center">{index + 1}</span>
                        <img
                          className="w-8 h-8 rounded-full"
                          src={`${imageUrl}/${teamImageId}`}
                          alt={`${teamName} logo`}
                        />
                        <span className="font-semibold">{teamName}</span>
                      </div>
                    </td>
                    <td className="py-3 px-4">{matchesPlayed}</td>
                    <td className="py-3 px-4">{matchesWon}</td>
                    <td className="py-3 px-4">{matchesLost}</td>
                    <td className="py-3 px-4">{nrr}</td>
                      ...
                      <div className="flex items-center gap-2 justify-center">
                        {form.reverse().map((result, i) =>
                          result === "W" ? (
                            ...
                            <GoXCircleFill key={i} size={20} className="text-red-500" />
                          ) : (
                            <p
                              key={i}
                              className="bg-gray-600 px-[5.5px] flex justify-center items-center text-sm rounded-full text-white"
                            >
                              A
                            </p>
                          )

...
const MatchDetail = () => {
  ...
  const teams = [{title :team1}, {title: team2}].filter(Boolean);

  return (
    <div className="w-full p-3">
      <h1 className="text-center font-semibold text-xl">Match Details</h1>
      {loading ? (
        <h1>Loading...</h1>
      ) : data ? (
        <InPageNavigation data={data} teams={teams} />
      ) : (
